      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <Card>
            ...
            <CardContent>
              <FileUpload accept="image/*" maxSize={5} onFileSelect={handleProfilePictureSelect} className="mb-4" />
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <Input id="phone" type="tel" defaultValue="+1 (613) 729-7400" className="pl-10 bg-muted/50" />
                  </div>
                </div>
