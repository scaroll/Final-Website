                              ...
                              {item.originalPrice && (
                                <>
                                  <span className="text-sm text-muted-foreground line-through">
                                    ${item.originalPrice.toLocaleString()} CAD
                                  </span>
                                  <Badge className="bg-red-100 text-red-700 text-xs">
                                    Save ${((item.originalPrice - item.price) * item.quantity).toLocaleString()} CAD
                                  </Badge>
                                </>
                              )}
                            </div>
                          ...
                          <div className="text-right">
                            ...
                            {item.originalPrice && (
                              <p className="text-sm text-green-600">
                                You save ${((item.originalPrice - item.price) * item.quantity).toLocaleString()} CAD
                              </p>
                            )}
                          </div>
                        </div>
